...
{
    STATIC_REQUIRE(modelled<975>(std::make_integer_sequence<int, end_id<975>>{}) == 53);
    STATIC_REQUIRE(modelled<1001>(std::make_integer_sequence<int, end_id<1001>>{}) == 54);
    STATIC_REQUIRE(modelled<2168>(std::make_integer_sequence<int, end_id<2168>>{}) == 54);
    STATIC_REQUIRE(modelled<2181>(std::make_integer_sequence<int, end_id<2181>>{}) == 55);
