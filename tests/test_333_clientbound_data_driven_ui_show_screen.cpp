...
// generated by gophertunnel (924): &packet.ClientBoundDataDrivenUIShowScreen{ScreenID: "demo"}
...
// The packet arrives at 924 carrying the screen id alone; the form id and the
// data instance id are appended at 944.
TEST_CASE("data-driven-ui show-screen is a lone screen id at 924")
{
    STATIC_REQUIRE_FALSE(bp::has_packet_v<898, 333>);
    STATIC_REQUIRE(bp::has_packet_v<924, 333>);

    using Packet = bp::ClientboundDataDrivenUIShowScreenPacket_<924>;

    Packet packet;
    packet.screen_id = "demo";
    REQUIRE(encode(packet) == golden_v924);
    REQUIRE(decode<Packet>(golden_v924).screen_id == "demo");
}
