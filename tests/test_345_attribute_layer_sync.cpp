...
// TODO: confirm against BDS. BoolAttributeData's operation is 0x01 0x00 0x00 0x00 0x00
// out of gophertunnel, a presence bool and an int32. r26_u3's EAS__BoolAttributeData
// dumps it as a name-coded string, which is the "OVERRIDE" the patched bytes carry
// instead. The two cannot both be the wire: once BDS settles it, either the patch goes
// or the field(type=str) in the schema does.
const std::string golden_v975 = bytes({
    0x02, 0x03, 0x77, 0x65, 0x74, 0x00, 0x01, 0x04, 0x74, 0x65, 0x6d, 0x70,
    0x00, 0x00, 0x01,
    0x08, 0x4f, 0x56, 0x45, 0x52, 0x52, 0x49, 0x44, 0x45,  // TODO: patched, confirm against BDS
