...
// TODO: confirm against BDS. InventorySource's container id is 0x0c out of gophertunnel,
// a raw int8. The member is a signed char carrying the cereal Compression trait, which
// r26_u3 dumps as varint32, so 12 zigzags to the patched 0x18. gophertunnel wrote a
// varint32 there before the cerealisation and an int8 after it, and Dragonfly reads
// container transactions, so its byte is not an idle guess either.
const std::string golden_normal_action = bytes({
    0x00, 0x00, 0x01, 0x00, 0x01, 0x01, 0x00, 0x01, 0x01,
    0x18,  // TODO: patched, confirm against BDS
    0x01, 0x00,
