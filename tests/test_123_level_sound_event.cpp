...
const std::string golden_tail = bytes({
    0x00, 0x00, 0x80, 0x3f,  // pos.x = 1.0f
    0x00, 0x00, 0x00, 0x40,  // pos.y = 2.0f
    0x00, 0x00, 0x40, 0x40,  // pos.z = 3.0f
    0x01,                    // data = -1 (varint32 zigzag)
    0x0d, 0x6d, 0x69, 0x6e, 0x65, 0x63, 0x72, 0x61, 0x66, 0x74, 0x3a, 0x70, 0x69,
    0x67,                    // actor_identifier = "minecraft:pig"
    0x01,                    // is_baby = true
    0x00,                    // is_global = false
    0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // actor = 7 (int64, not a varint)
    0x01,                    // fire_at_position present
    0x00, 0x00, 0x80, 0x40,  //   x = 4.0f
    0x00, 0x00, 0xa0, 0x40,  //   y = 5.0f
    0x00, 0x00, 0xc0, 0x40,  //   z = 6.0f
});
...
const std::string golden_v975 = bytes({
    0x82, 0x02,  // event_id = BELL (258, uvarint32)
}) + golden_tail;
...
const std::string golden_v1001 = bytes({
    0x0e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x62, 0x65, 0x6c, 0x6c, 0x2e, 0x68, 0x69,
    0x74,  // sound_event = "block.bell.hit"
}) + golden_tail;
