...
const std::string golden_gradient_v975 = bytes({
    ...
    0x01,                    //   [0].rain = true
    0x00,                    //   [0].tags absent
    0x01,                    //   [0].chunk_gen_data present
    0x00, 0x00, 0x00, 0x00,  //     climate, consolidated_features, mountain_params,
    0x00, 0x00, 0x00, 0x00,  //     surface_material_adjustments, overworld_gen_rules,
    0x00,                    //     multinoise, legacy_world_gen_rules, replace_biomes,
                             //     village_type -- all absent
    0x01,                    //     surface_builder_data present
    0x00,                    //       surface_materials absent
    0x00, 0x00, 0x00, 0x00,  //       the four has_*_surface flags = false
    0x00, 0x00,              //       mesa_surface, capped_surface absent
    0x01,                    //       noise_gradient_surface present
    ...
    0x00,                    //     subsurface_builder_data absent
    0x02,                    // string_list.strings: count = 2
    0x06, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x73,  //   [0] = "plains"
    0x03, 0x74, 0x61, 0x67,                    //   [1] = "tag"
});
...
const std::string golden_gradient_v1001 = bytes({
    ...
    0x00,                    //   [0].tags absent
    0x01,                    //   [0].chunk_gen_data present
    0x00, 0x00, 0x00, 0x00,  //     the nine leading optionals, all absent
    0x00, 0x00, 0x00, 0x00,  //
    0x00,                    //
    0x01,                    //     surface_builder_data present
    0x00,                    //       surface_materials absent
    ...
    0x02,                    //           noise_descriptor.amplitudes: count = 2
    0x00, 0x00, 0x80, 0x3f,  //             [0] = 1.0f
    0x00, 0x00, 0x00, 0x3f,  //             [1] = 0.5f
    0x00,                    //     subsurface_builder_data absent
    0x02,                    // string_list.strings: count = 2
