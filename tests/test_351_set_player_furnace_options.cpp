...
// 2193 added the packet, so there is no golden: gophertunnel and CloudburstMC both stop
...
{
    STATIC_REQUIRE(bp::SetPlayerFurnaceOptionsPacket_<2193>::Id == 351);
    STATIC_REQUIRE(bp::has_packet_v<2193, 351>);
    STATIC_REQUIRE_FALSE(bp::has_packet_v<2168, 351>);
}

TEST_CASE("SetPlayerFurnaceOptionsPacket: v2193 round-trip")
{
    using Packet = bp::SetPlayerFurnaceOptionsPacket_<2193>;
