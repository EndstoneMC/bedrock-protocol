...
{
    STATIC_REQUIRE(bp::SetPlayerFurnaceOptionsPacket_<2192>::Id == 351);
    STATIC_REQUIRE(bp::has_packet_v<2192, 351>);
    STATIC_REQUIRE_FALSE(bp::has_packet_v<2168, 351>);
}

TEST_CASE("SetPlayerFurnaceOptionsPacket: v2192 round-trip")
{
