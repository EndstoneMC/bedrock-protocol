...
class CurrentCmdVersion(Enum):
    ...
    POST_BLOCK_FLATTENING = value(43, since=786)
    TEST_FOR_BLOCK_COMMAND_DOES_NOT_IGNORE_BLOCK_STATE = value(44, since=818)
    CLONE_EXTRA_BLOCK_FILTER_FIX = value(45, since=898)
