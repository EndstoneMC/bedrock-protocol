...
class ActorFlags(IntEnum):
    ...
    RENDERS_WHEN_INVISIBLE = value(119, since=776)
    ROTATION_AXIS_ALIGNED = value(120, since=786)
    COLLIDABLE = value(121, since=786)
    WASD_FREE_CAMERA_CONTROLLED = value(122, since=786)
...
class ActorDataIDs(IntEnum, uint8):
    ...
    FILTERED_NAME = value(132, since=776)
    ENTER_BED_POSITION = value(133, since=776)
...
class ActorType(IntEnum):
    ...
    DONKEY = 2118424
    MULE = 2118425
    SKELETON_HORSE = value(2186010, until=924)
    SKELETON_HORSE = value(2183962, since=924)
    ZOMBIE_HORSE = value(2186011, until=924)
    ZOMBIE_HORSE = value(2183963, since=924)
    ZOMBIE = 199456
    CREEPER = 2849
    SKELETON = 1116962
    SPIDER = 264995
    ...
    PARCHED = 1117079
    CAMEL_HUSK = value(68504, until=924)
    CAMEL_HUSK = value(70552, since=924)
